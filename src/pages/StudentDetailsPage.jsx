...
function StudentDetailsPage() {
  ...
  const { studentId } = useParams(); // Usamos el hook useParams para obtener el valor del parámetro studentId directamente de la URL permitiendo que se muestre información dinámica
